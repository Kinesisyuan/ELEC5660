...
if("FALSE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/kinesis/catkin_ws/src/ekf)
  set(ekf_DEVEL_PREFIX /home/kinesis/catkin_ws/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/kinesis/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kinesis/catkin_ws/install/${idir}'.  Ask the maintainer 'kunyue <ksu@todo.todo>' to fix it.")
    endif()
